...
If you provide a reference genome, Physlr maps the physical map to the input reference and outputs a PAF file. You can use it to calculate assembly-like quality metrics for the physical map (see command below).
```
